							...
							<div class="card">
								<div class="card-body visits pt-0">
									<div class="visit-col pt-3 pb-3">                      
										<span><a href="choose-service"><span class="back-left"><i class="fas fa-chevron-left"></i>  </span>Back</a></span>
										...
										<p class="choose-top pl-5 pt-5 pb-2">OR CHOOSE FROM TOP REASONS</p>
										<div class="row" id="myDIV">                        
											<div class="col-md-6">
												...
												<div class="form-check">
													<label class="form-check-label visit-btns">
														<input type="checkbox" class="form-check-input" value="">
														<span class="visit-rsn">Animal Bite</span>
													</label>
												</div>
												<div class="form-check">
													<label class="form-check-label visit-btns">
