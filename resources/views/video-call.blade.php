												...
												<div class="user-details">
													<div class="float-left user-img">
														<a class="avatar avatar-sm mr-2" href="patient-profile" title="Charlene Reed">
															<img src="assets/img/counsellors/counsellor-01.jpg" alt="User Image" class="rounded-circle">
															<span class="status online"></span>
														</a>
													</div>
													<div class="user-info float-left">
														<a href="teacher-profile"><span>Charlene Reed</span></a>
										...
										<div class="call-contents">
											<div class="call-content-wrap">
												...
												<div class="my-video">
													<ul>
														<li>
															<img src="assets/img/counsellors/counsellor-07.jpg" class="img-fluid" alt="User Image">
														</li>
													</ul>
												</div>
											</div>
