									...
									<div class="tab-content">
										...
										<div class="tab-pane fade" id="pres">
											<div class="text-right">
												<a href="javascript:void(0);" class="add-new-btn">Add Prescription</a>
											</div>
											<div class="card card-table mb-0">
												<div class="card-body">
													<div class="table-responsive">
															...
															<tbody>
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="councellor-profile" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="assets/img/counsellors/counsellor-thumb-03.jpg" alt="User Image">
																			</a>
																			<a href="councellor-profile">Deborah Angel <span>Counsellor</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="councellor-profile" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="assets/img/counsellors/counsellor-thumb-04.jpg" alt="User Image">
																			</a>
																			<a href="councellor-profile">Sofia Brient <span>Counsellor</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="councellor-profile" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="assets/img/counsellors/counsellor-thumb-05.jpg" alt="User Image">
																			</a>
																			<a href="councellor-profile">Marvin Campbell <span>Counsellor</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="councellor-profile" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="assets/img/counsellors/counsellor-thumb-06.jpg" alt="User Image">
																			</a>
																			<a href="councellor-profile">Katharine Berthold <span>Counsellor</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="councellor-profile" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="assets/img/counsellors/counsellor-thumb-07.jpg" alt="User Image">
																			</a>
																			<a href="councellor-profile">Linda Tobin <span>Counsellor</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="councellor-profile" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="assets/img/counsellors/counsellor-thumb-08.jpg" alt="User Image">
																			</a>
																			<a href="councellor-profile">Paul Richard <span>Counsellor</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="councellor-profile" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="assets/img/counsellors/counsellor-thumb-09.jpg" alt="User Image">
																			</a>
																			<a href="councellor-profile">John Gibbs <span>Counsellor</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			<a href="councellor-profile" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="assets/img/counsellors/counsellor-thumb-10.jpg" alt="User Image">
																			</a>
																			<a href="councellor-profile">Olga Barlow <span>Counsellor</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
														...
														<table class="table table-hover table-center mb-0">
															...
															<tbody>
																...
																<tr>
																	...
																	<td><a href="#">young-adult-test.pdf</a></td>
																	<td>
																		<h2 class="table-avatar">
																			<a href="councellor-profile" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="assets/img/counsellors/counsellor-thumb-03.jpg" alt="User Image">
																...
																<tr>
																	...
																	<td>10 Nov 2019</td>
																	<td>Direct Counseling</td>
																	<td><a href="#">online-counseling-test.pdf</a></td>
																	<td>
																		<h2 class="table-avatar">
																			<a href="councellor-profile" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="assets/img/counsellors/counsellor-thumb-05.jpg" alt="User Image">
																...
																<tr>
																	...
																	<td>9 Nov 2019</td>
																	<td>Direct Counseling</td>
																	<td><a href="#">direct-counseling-test.pdf</a></td>
																	<td>
																		<h2 class="table-avatar">
																			<a href="councellor-profile" class="avatar avatar-sm mr-2">
																				<img class="avatar-img rounded-circle" src="assets/img/counsellors/counsellor-thumb-06.jpg" alt="User Image">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="councellor-profile">Olga Barlow <span>#0010</span></a>
																		</h2>
																	</td>
																	<td>$550</td>
																	<td>5 Nov 2019</td>
